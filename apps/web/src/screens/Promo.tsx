import { calendar as CAL, industries as IND, upgrades as UP } from '@shopflow/data';
import { hourMult, orderRate, trafficEnvMult, type GameState } from '@shopflow/sim';
    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-xl border-2 border-dashed border-slate-200 bg-white/60 p-3">
          ...
          <p className="mt-0.5 text-xs text-slate-400">Mở ở màn 3</p>
        </div>
